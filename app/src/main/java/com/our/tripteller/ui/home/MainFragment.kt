...
class MainFragment : Fragment() {
    ...
    private fun loadHomeDatas() {
        homeData.apply {
            ...
            add (HomeData(id = 5, mainimg = "https://images.unsplash.com/photo-1612977512598-3b8d6a498bbb?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=967&q=80", region = "제주도", intro1 = "20대의 제주도 알바생이 추천하는", intro2 = "제주도 여행일지", tag1 = "커플여행", tag2 = "우정여행", tag3 = "나홀로여행", tag4 = "자연", tag5 = null, tag6 = null, cnt = 4))
            add (HomeData(id = 6, mainimg = "https://images.unsplash.com/photo-1563354616-0dd25227694d?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=675&q=80", region = "경상도", intro1 = "경주는 수학여행?", intro2 = "아니, 커플여행!", tag1 = "커플여행", tag2 = "가족여행", tag3 = "자연", tag4 = null, tag5 = null, tag6 = null, cnt = 3))
            add (HomeData(id = 7, mainimg = "https://images.unsplash.com/photo-1509327522225-6ce58f4795c7?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1601&q=80", region = "경기도", intro1 = "경희대학생이 알려주는", intro2 = "아름다운 수원 투어", tag1 = "커플여행", tag2 = "맛집투어", tag3 = "뚜벅이", tag4 = null, tag5 = null, tag6 = null, cnt = 3))
        }
